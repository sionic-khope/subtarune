...
export const YOUNGCLE_SPECIAL = {
  ...
  // 두 번째 판이 있는 종류(2026-09-18 사용자 “섭리오랑 마녀재판 각각 두 번째 패턴”): 짝수 번째 방문은 B 판
  variants: ['subrio', 'trial'],
  ...
  trial: {
    ...
    // 두 번째 사건(2026-09-18 사용자 원문, 3번이 정답): 편집자 따뜻한비데 부당 해고 — 옆에 우는 따뜻한비데(gpt warm-bidet-cry.png). 개정·판결·호옥·망치는 첫 사건과 같다
    b: {
      chargeLines: ['피고인 요플래는 편집자 따뜻한비데를 정당한 해고사유없이', '잘라낸것으로 알고있습니다 맞습니까?'],
      summary: '죄명: 편집자 따뜻한비데 부당 해고',
      highlight: '따뜻한비데',
      choices: ['맞습니다', '비데 애미창년아 그걸꼰지르냐', '너네엄마가 사장이였어도 잘랐을거다 꼬라지를 봐라'],
      victim: 'assets/illustrations/warm-bidet-cry.png',
    },
  },
