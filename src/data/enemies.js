...
export const ENEMIES = {
  mankatsuki_junhee: {
    ...
    patterns: [
      { type: 'mankatsuki_teleport', duration: 6.2, waves: 7, every: 0.68 },
      { type: 'mankatsuki_food_taco', duration: 6.6, waves: 4, every: 1.25, warn: 0.7, flight: 0.65, chipSpeed: 58 },
      { type: 'mankatsuki_motorcycle', duration: 6.6, waves: 4, every: 1.35, warn: 0.75, speed: 280 },
      { type: 'mankatsuki_stampede', duration: 7, safeSize: 58, fall: 0.3 },
      { type: 'mankatsuki_pan', duration: 6, waves: 7, every: 0.66,
        positions: [0.14, 0.82, 0.4, 0.66, 0.06, 0.94] },
      { type: 'mankatsuki_stocks', duration: 6.2, waves: 7, every: 0.72, aim: true },
      { type: 'mankatsuki_taco', duration: 6.8, warn: 0.85, speed: 276, size: 42, r: 12,
        start: 0.2, waveGap: 1.8, stagger: 0.34, inset: 22, recover: 0.24,
    ...
    enragedPatterns: [
      { type: 'mankatsuki_food_motorcycle', duration: 7.4, motorcycleAt: 0.65,
        food: { duration: 6.6, waves: 4, every: 1.4, warn: 0.7, flight: 0.65, chipSpeed: 58 },
        motorcycle: { duration: 6.6, waves: 3, every: 1.8, warn: 0.8, speed: 280 } },
      { type: 'mankatsuki_taco_pan', duration: 7.4, panAt: 0.65,
        taco: { duration: 7.4, warn: 0.85, speed: 276, waveGap: 2, stagger: 0.35,
          edges: [[0, 0.2], [0.55, 0], [1, 0.65], [1, 0.2], [0.45, 1], [0, 0.65], [0.25, 0], [1, 0.45], [0.7, 1]] },
        pan: { duration: 6.7, waves: 3, every: 1.85, warn: 0.6, positions: [0.18, 0.82, 0.5] } },
      { type: 'mankatsuki_taco_stocks', duration: 7.4, stocksAt: 0.35,
        taco: { duration: 7.4, warn: 0.85, speed: 276, waveGap: 2, stagger: 0.35,
          edges: [[0, 0.2], [0.55, 0], [1, 0.65], [1, 0.2], [0.45, 1], [0, 0.65], [0.25, 0], [1, 0.45], [0.7, 1]] },
        stocks: { duration: 6.7, waves: 3, every: 1.95, warn: 0.75, aim: true } },
      { type: 'mankatsuki_teleport_taco', duration: 7.8, tacoAt: 1.1,
        teleport: { duration: 7.4, waves: 6, every: 0.95, warn: 0.55 },
        taco: { duration: 6.6, warn: 0.85, speed: 276, waveGap: 2.8, stagger: 0.42 } },
    ],
    lines: {
