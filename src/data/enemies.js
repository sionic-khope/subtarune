...
export const ENEMIES = {
  ...
  teen_giant: {
    ...
    // BUILD342: 필드 대치와 같은 그림·같은 화면 자리(teen-battle.js view.giant = 175,2 → ENEMY_X 396/ENEMY_YS 176 기준 dx·dy). 숨쉬기 없음
    ...
    actions: {
      ...
      slam: { src: 'assets/props/teen342_slam.png', cols: 1, rows: 1, count: 1, fps: 1, px: 1, pivot: [0, 0] },
      down: { src: 'assets/props/teen342_down.png', cols: 1, rows: 1, count: 1, fps: 1, px: 1, pivot: [10, -28] },
    },
    pivot: [0, 0], scale: 1, dx: -221, dy: -174, board: [300, 150], idle: { swayX: 0, swayY: 0 },
