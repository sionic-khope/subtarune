...
export const ENEMIES = {
  mankatsuki_junhee: {
    ...
    patterns: [
      { type: 'mankatsuki_teleport', duration: 6.2, waves: 6, every: 0.8 },
      { type: 'mankatsuki_stampede', duration: 7, safeSize: 58 },
      { type: 'mankatsuki_pan', duration: 6, waves: 6, every: 0.78,
        positions: [0.14, 0.82, 0.4, 0.66, 0.06, 0.94] },
      { type: 'mankatsuki_stocks', duration: 6.2, waves: 6, every: 0.86, aim: true },
      { type: 'mankatsuki_taco', duration: 6.8, warn: 0.85, speed: 240, size: 42, r: 12,
    ...
    enragedPatterns: [
      { type: 'mankatsuki_taco_pan', duration: 7.4, panAt: 0.65,
        taco: { duration: 7.4, warn: 0.85, waveGap: 2, stagger: 0.35,
          edges: [[0, 0.2], [0.55, 0], [1, 0.65], [1, 0.2], [0.45, 1], [0, 0.65], [0.25, 0], [1, 0.45], [0.7, 1]] },
      ...
      { type: 'mankatsuki_teleport_taco', duration: 7.8, tacoAt: 1.1,
        ...
        taco: { duration: 6.6, warn: 0.85, waveGap: 2.8, stagger: 0.42 } },
    ],
    lines: {
