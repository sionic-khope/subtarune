...
export default {
  ...
  battle_choimis_pink_round_controls: '↑↓ 이동 · C 발사/충전 · 최미스 3발=1 피해',
  battle_choimis_pink_choso: '최미스를 6번 맞혀 혈광선을 멈춰라',
  battle_choimis_pink_kart: '다오·배찌를 4명 쏴서 막자를 뚫어라',
  battle_choimis_pink_prism: 'C를 끝까지 충전해 방패를 깨고 코어를 3번 맞혀라',
  battle_choimis_eating_goal: '먼저 다 먹어치워라!',
  battle_choimis_eating_start: '시작!',
  battle_choimis_eating_party: '요플래 → 경섭 → 억빠맨',
  battle_choimis_eating_hyungsub: '요플래',
  battle_choimis_eating_gyeongsub: '경섭',
  battle_choimis_eating_ppaman: '억빠맨',
  battle_choimis_eating_controls: 'C를 눌렀다 떼며 연타 · 한 번에 한 입',
  battle_choimis_eating_intro: '시작 신호가 나오면 세 그릇을 먹어라!',
  battle_choimis_eating_loading: '먹기 대결 영상을 준비하는 중...',
  battle_choimis_eating_error: '영상을 재생하지 못해 대결을 건너뜁니다.',
  battle_choimis_eating_win: '먼저 다 먹었다! 최미스에게 10 피해!',
  battle_choimis_eating_lose: '최미스가 먼저 먹었다! 모두 15 피해!',
