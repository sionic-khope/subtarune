...
export default {
  ...
  boot_loading: '섭타룬을 로딩하고있습니다.',
  esc_confirm_title: '경고',
  esc_confirm_lines: ['타이틀로 돌아갑니다.', '저장하지 않은 진행은 사라질 수 있습니다.'],
  esc_confirm_yes: '예',
  esc_confirm_no: '아니요',
  qa_help: '↑↓ 고르기   ←→ 페이지   C 이동   X 닫기',
  loading_error: '맵을 불러오지 못했습니다. 다시 시도해주세요.',
  battle_choimis_pink_choso_preamble: '내 추구미는 쵸소우야',
  ...
  menu_use_all: '일행 전체에게 사용',
  menu_use_all_controls: 'C 사용 · X 취소',
  battle_item_party: '일행 모두',
  battle_item_used: '* {actor} 이(가) {target}에게 {item} 을(를) 썼다.',
