...
export const YOUNGCLE_BATTLE = {
  hp: 10, ideaHits: 9, ideaRollback: 6, ideaDamage: 3, distractedDamage: 1, distractedHits: 3,
  sfx: { kieek: 'queen_kieek', boom: 'furnace_blast' },
  intro: [
  ...
  idea2: {
    before: [P('방순이를 잘 이용해볼 수 있을거같아요.'), G('어떻게 그게 가능하지?'), P('야 오방순!'), O('흐어어 네???'), P('오방순의 트라우마를 건들만한 말을 해야될거같아요.'), P('각각의 선택지들중에 알맞는답들을 골라야할거같아요')],
    quiz: [
      { q: '1. 돈과 관련된건 뭐지?', a: ['컴퓨터 사기', '닌텐도 스위치 사기'], answer: 1 },
  ...
  finale: {
    ...
    slam: J('마이야르 점프슬램!!!!!!!!!!!!'),
    crawlSteps: 5, crawlStep: 34, crawlSeconds: 0.5, crawlPause: 0.65, ground: 300, startX: -30,
