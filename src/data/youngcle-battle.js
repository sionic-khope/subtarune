...
export const YOUNGCLE_BATTLE = {
  ...
  idea1: {
    before: [P('나람이의 구르기는 강력하지만'), P('저걸 틩겨낼수있을거같아요'), G('어떻게?'), P('잠시만요!')],   // ‘잠시만요!’ 뒤 억빠맨이 천천히 걸어 들어간다(사용자 2026-09-17)
  ...
  idea2: {
    ...
    quiz: [
      ...
      { q: '3. 그녀가 탐내는 남자는?', a: ['행복맨', '육북이'], answer: 0 },   // ‘그녀와’ 오타 정정(사용자 2026-09-17)
      { q: '4. 그녀의 업적을 비판하려면?', a: ['똥이든성배 부정선거', '완벽한 우승'], answer: 0 },   // ‘그녀이’ 오타 정정(사용자 2026-09-17)
    ],
  ...
  finale: {
    ...
    slam: J('마이야르 점프슬램!!!!!!!!!!!!'),
    crawlSteps: 5, crawlStep: -20, crawlSeconds: 0.5, crawlPause: 0.65, ground: 112, startX: 534,   // 오른쪽 위(영클 뒤통수 높이, 나람 위)에서 왼쪽으로 기어와 영클 뒤에 멈춘다(사용자: “오른쪽에서 왼쪽으로”, “상단에서”)
