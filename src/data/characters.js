...
export const CHARACTERS = {
  ...
  red:       { name: '레드', voice: 'red', palette: 'ghost', still: 'assets/enemies/red-front.png' },        // 청록숲9 사원 문지기(NPC → 전투). PR #16 정면 64×64(레드 브램블백 모티브). 목소리 낮고 드문 합성(audio.js VOICES.red)
  blue:      { name: '블루', voice: 'blue', palette: 'ghost', still: 'assets/enemies/blue-front.png' },      // PR #16 (블루 센티넬 모티브)
