...
export const CHARACTER_MOTIONS = {
  ...
  hyungsub: {
    ...
    runner_prep: {
      ...
      frames: [
        { rect: [0, 0, 512, 512], pivot: [293, 451], duration: 0.24 },
        { rect: [512, 0, 512, 512], pivot: [232, 451], duration: 0.26 },
        { rect: [0, 512, 512, 512], pivot: [245, 419], duration: 0.12 },
        { rect: [512, 512, 512, 512], pivot: [238, 419], duration: 0.1 },
      ],
    },
    runner_run: {
      ...
      colorKey: { rMin: 150, gMax: 110, bMin: 150 },
      frames: [
        { rect: [0, 0, 512, 512], pivot: [232, 426], duration: 0.08 },
        { rect: [512, 0, 512, 512], pivot: [202, 436], duration: 0.08 },
        { rect: [0, 512, 512, 512], pivot: [231, 414], duration: 0.08 },
        { rect: [512, 512, 512, 512], pivot: [202, 419], duration: 0.08 },
      ],
    },
    runner_jump: {
      ...
      colorKey: { rMin: 150, gMax: 110, bMin: 150 },
      frames: [
        { rect: [0, 0, 512, 512], pivot: [230, 444], duration: 0.08 },
        { rect: [512, 0, 512, 512], pivot: [195, 415], duration: 0.2 },
        { rect: [0, 512, 512, 512], pivot: [228, 396], duration: 0.2 },
        { rect: [512, 512, 512, 512], pivot: [238, 437], duration: 0.16 },
      ],
    },
    runner_slash: {
      ...
      colorKey: { rMin: 150, gMax: 110, bMin: 150 },
      frames: [
        { rect: [0, 0, 512, 512], pivot: [272, 448], duration: 0.08 },
        { rect: [512, 0, 512, 512], pivot: [304, 448], duration: 0.08 },
        { rect: [0, 512, 512, 512], pivot: [274, 408], duration: 0.08 },
        { rect: [512, 512, 512, 512], pivot: [196, 408], duration: 0.08 },
      ],
    },
    runner_airslash: {
      ...
      colorKey: { rMin: 150, gMax: 110, bMin: 150 },
      frames: [
        { rect: [0, 0, 512, 512], pivot: [294, 442], duration: 0.09 },
        { rect: [512, 0, 512, 512], pivot: [194, 452], duration: 0.09 },
        { rect: [0, 512, 512, 512], pivot: [266, 421], duration: 0.09 },
        { rect: [512, 512, 512, 512], pivot: [209, 400], duration: 0.09 },
      ],
    },
  },
  expelled_viewer: {
