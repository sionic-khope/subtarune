...
export const CHARACTER_MOTIONS = {
  ...
  hyungsub: {
    ...
    // 러너 시트 7판(BUILD241, 사용자 2026-09-19 “검이 너무 길어지고 고개를 숙이고 앞으로 달린다는 느낌이 덜 듦, 무게중심 앞으로, 눈이 너무 초롱초롱” + 크리스 달리기 참조): pivot = [흰 셔츠 가운데, 발 밑변], scale = 46px / 달리기 평균 키 — assets/source/runner-v1/runner-contract.json
    runner_prep: {
      ...
      frames: [
        { rect: [0, 0, 512, 512], pivot: [259, 431], duration: 0.24 },
        { rect: [512, 0, 512, 512], pivot: [239, 431], duration: 0.26 },
        { rect: [0, 512, 512, 512], pivot: [246, 409], duration: 0.12 },
        { rect: [512, 512, 512, 512], pivot: [252, 411], duration: 0.1 },
      ],
    },
    runner_run: {
      ...
      colorKey: { rMin: 150, gMax: 110, bMin: 150 },
      frames: [
        { rect: [0, 0, 512, 512], pivot: [250, 431], duration: 0.08 },
        { rect: [512, 0, 512, 512], pivot: [250, 434], duration: 0.08 },
        { rect: [0, 512, 512, 512], pivot: [250, 426], duration: 0.08 },
        { rect: [512, 512, 512, 512], pivot: [250, 434], duration: 0.08 },
      ],
    },
    runner_jump: {
      ...
      colorKey: { rMin: 150, gMax: 110, bMin: 150 },
      frames: [
        { rect: [0, 0, 512, 512], pivot: [237, 424], duration: 0.08 },
        { rect: [512, 0, 512, 512], pivot: [245, 401], duration: 0.2 },
        { rect: [0, 512, 512, 512], pivot: [252, 373], duration: 0.2 },
        { rect: [512, 512, 512, 512], pivot: [237, 411], duration: 0.16 },
      ],
    },
    runner_slash: {
      ...
      colorKey: { rMin: 150, gMax: 110, bMin: 150 },
      frames: [
        { rect: [0, 0, 512, 512], pivot: [248, 457], duration: 0.08 },
        { rect: [512, 0, 512, 512], pivot: [218, 457], duration: 0.08 },
        { rect: [0, 512, 512, 512], pivot: [264, 409], duration: 0.08 },
        { rect: [512, 512, 512, 512], pivot: [205, 409], duration: 0.08 },
      ],
    },
    runner_airslash: {
      ...
      colorKey: { rMin: 150, gMax: 110, bMin: 150 },
      frames: [
        { rect: [0, 0, 512, 512], pivot: [252, 435], duration: 0.09 },
        { rect: [512, 0, 512, 512], pivot: [239, 444], duration: 0.09 },
        { rect: [0, 512, 512, 512], pivot: [225, 372], duration: 0.09 },
        { rect: [512, 512, 512, 512], pivot: [217, 394], duration: 0.09 },
      ],
    },
  },
  expelled_viewer: {
