...
export const CHARACTER_MOTIONS = {
  ...
  hyungsub: {
    ...
    runner_prep: {
      ...
      frames: [
        { rect: [0, 0, 512, 512], pivot: [259, 460], duration: 0.24 },
        { rect: [512, 0, 512, 512], pivot: [268, 460], duration: 0.26 },
        { rect: [0, 512, 512, 512], pivot: [278, 434], duration: 0.12 },
        { rect: [512, 512, 512, 512], pivot: [276, 433], duration: 0.1 },
      ],
    },
    runner_run: {
      ...
      colorKey: { rMin: 150, gMax: 110, bMin: 150 },
      frames: [
        { rect: [0, 0, 512, 512], pivot: [261, 459], duration: 0.08 },
        { rect: [512, 0, 512, 512], pivot: [282, 459], duration: 0.08 },
        { rect: [0, 512, 512, 512], pivot: [256, 428], duration: 0.08 },
        { rect: [512, 512, 512, 512], pivot: [282, 433], duration: 0.08 },
      ],
    },
    runner_jump: {
      ...
      colorKey: { rMin: 150, gMax: 110, bMin: 150 },
      frames: [
        { rect: [0, 0, 512, 512], pivot: [288, 423], duration: 0.08 },
        { rect: [512, 0, 512, 512], pivot: [228, 399], duration: 0.2 },
        { rect: [0, 512, 512, 512], pivot: [284, 396], duration: 0.2 },
        { rect: [512, 512, 512, 512], pivot: [278, 444], duration: 0.16 },
      ],
    },
    runner_slash: {
      ...
      colorKey: { rMin: 150, gMax: 110, bMin: 150 },
      frames: [
        { rect: [0, 0, 512, 512], pivot: [238, 448], duration: 0.08 },
        { rect: [512, 0, 512, 512], pivot: [292, 448], duration: 0.08 },
        { rect: [0, 512, 512, 512], pivot: [258, 424], duration: 0.08 },
        { rect: [512, 512, 512, 512], pivot: [227, 424], duration: 0.08 },
      ],
    },
    runner_airslash: {
      ...
      colorKey: { rMin: 150, gMax: 110, bMin: 150 },
      frames: [
        { rect: [0, 0, 512, 512], pivot: [254, 444], duration: 0.09 },
        { rect: [512, 0, 512, 512], pivot: [250, 444], duration: 0.09 },
        { rect: [0, 512, 512, 512], pivot: [270, 449], duration: 0.09 },
        { rect: [512, 512, 512, 512], pivot: [240, 422], duration: 0.09 },
      ],
    },
  },
  expelled_viewer: {
