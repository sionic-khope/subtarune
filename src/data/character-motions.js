...
export const CHARACTER_MOTIONS = {
  ...
  hyungsub: {
    ...
    runner_prep: {
      ...
      frames: [
        { rect: [0, 0, 512, 512], pivot: [305, 419], duration: 0.24 },
        { rect: [512, 0, 512, 512], pivot: [218, 419], duration: 0.26 },
        { rect: [0, 512, 512, 512], pivot: [250, 377], duration: 0.12 },
        { rect: [512, 512, 512, 512], pivot: [232, 378], duration: 0.1 },
      ],
    },
    runner_run: {
      ...
      colorKey: { rMin: 150, gMax: 110, bMin: 150 },
      frames: [
        { rect: [0, 0, 512, 512], pivot: [231, 416], duration: 0.08 },
        { rect: [512, 0, 512, 512], pivot: [210, 420], duration: 0.08 },
        { rect: [0, 512, 512, 512], pivot: [231, 398], duration: 0.08 },
        { rect: [512, 512, 512, 512], pivot: [208, 399], duration: 0.08 },
      ],
    },
    runner_jump: {
      ...
      colorKey: { rMin: 150, gMax: 110, bMin: 150 },
      frames: [
        { rect: [0, 0, 512, 512], pivot: [234, 413], duration: 0.08 },
        { rect: [512, 0, 512, 512], pivot: [216, 389], duration: 0.2 },
        { rect: [0, 512, 512, 512], pivot: [218, 353], duration: 0.2 },
        { rect: [512, 512, 512, 512], pivot: [230, 413], duration: 0.16 },
      ],
    },
    runner_slash: {
      ...
      colorKey: { rMin: 150, gMax: 110, bMin: 150 },
      frames: [
        { rect: [0, 0, 512, 512], pivot: [318, 453], duration: 0.08 },
        { rect: [512, 0, 512, 512], pivot: [284, 453], duration: 0.08 },
        { rect: [0, 512, 512, 512], pivot: [260, 418], duration: 0.08 },
        { rect: [512, 512, 512, 512], pivot: [220, 386], duration: 0.08 },
      ],
    },
    runner_airslash: {
      ...
      colorKey: { rMin: 150, gMax: 110, bMin: 150 },
      frames: [
        { rect: [0, 0, 512, 512], pivot: [330, 439], duration: 0.09 },
        { rect: [512, 0, 512, 512], pivot: [290, 438], duration: 0.09 },
        { rect: [0, 512, 512, 512], pivot: [272, 423], duration: 0.09 },
        { rect: [512, 512, 512, 512], pivot: [222, 358], duration: 0.09 },
      ],
    },
  },
  expelled_viewer: {
