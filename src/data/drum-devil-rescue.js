...
export const DRUM_DEVIL_RESCUE = Object.freeze({
  bgm: 'janitor_hero_intro', fade: 1.2, silence: 2, flight: 1.1, surpriseHold: 0.65, lookbackHold: 0.65, reveal: 4.8,
  focusSeconds: 0.75, revealZoom: 0.8, focusZoom: 0.88, revealPan: 500, revealCenterX: 208, focusShake: 1.2,
  flagImpact: { duration: 0.45, recoil: 12, flash: 0.1, shake: 0.3, amp: 3, sound: 'deltarune_release_shoot' },
  speech: { width: 250, pad: 10, lineHeight: 18, fontSize: 14, headOffset: 64, postLanding: { x: 12, width: 156 } },
  ...
  hero: { src: 'assets/battle/janitor-hero-idle.png', cell: 192, cols: 2, pivot: [138, 180], scale: HERO_SCALE, frameHolds: [0.1, 0.12, 0.28, 0.14, 0.1, 0.12, 0.28, 0.14], home: [144, 238], reveal: [-260, 206] },
