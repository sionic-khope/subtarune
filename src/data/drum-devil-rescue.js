...
export const DRUM_DEVIL_RESCUE = Object.freeze({
  ...
  speech: { width: 250, minWidth: 64, pad: 10, lineHeight: 18, fontSize: 14, headOffset: 64, postLanding: { x: 12, y: 172, width: 100, fontSize: 12, lineHeight: 16, headOffset: 55 }, offscreen: { x: 12, y: 44, tail: 14, slide: 0.22 } },
  ...
  hero: { src: 'assets/battle/janitor-hero-idle.png', cell: 192, cols: 2, pivot: [138, 180], scale: HERO_SCALE, frameHolds: [0.1, 0.12, 0.28, 0.14, 0.1, 0.12, 0.28, 0.14], home: [122, 238], attackHome: [138, 238], reveal: [-260, 250], riseTo: -104 },
