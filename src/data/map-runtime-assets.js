...
export const MAP_RUNTIME_ASSETS = {
  ...
  gajaeman_castle_right1: {
    portraits: ['gyeongsub', 'ppaman'],
    images: ['assets/backdrops/castle307_right.png', 'assets/props/castle-memory-door.png', 'assets/props/signpost.png'],
  },
  gajaeman_memory1: { sprites: ['seobruto'], images: ['assets/backdrops/castle307_right.png'] },
  gajaeman_memory2: { sprites: ['jiroesub', 'udyrsub'], images: ['assets/backdrops/castle307_right.png'] },
  gajaeman_castle_left1: { portraits: ['gyeongsub', 'ppaman'] },
  gajaeman_regret1: { sprites: ['yisub'] },
  gajaeman_regret2: { sprites: ['syndrasub', 'taliyahsub', 'aurelionsub'] },
