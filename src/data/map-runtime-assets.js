...
export const MAP_RUNTIME_ASSETS = {
  ...
  jjajang_sakura8: { sprites: ['gyeongsub', 'ppaman'], portraits: ['gyeongsub', 'ppaman'] },   // 벚꽃 숲 8(BUILD282): 갈림길 연출용 경섭·억빠맨 사본 NPC + 가드
  ...
  jjajang_sakura6: { sprites: ['choimis_masked'], portraits: ['choimis', 'gyeongsub', 'ppaman'] },   // 벚꽃 숲 6(BUILD277): 광장의 가면 쓴 최미스(고백 연습 연출)
