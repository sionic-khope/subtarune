...
export const MAP_RUNTIME_ASSETS = {
  ...
  jjajang_sakura2: { sprites: ['choimis', 'gasuni1', 'gasuni2', 'gasuni3'], portraits: ['choimis', 'gasuni1', 'ppaman'] },   // 벚꽃 숲 2(BUILD264): 벚꽃다리 위 가면 쓴 최미스·가순이 셋   // 빛 드는 공터(BUILD257): 풀숲의 최미스·가순이 셋
