...
export const MAP_RUNTIME_ASSETS = {
  ...
  jjajang_nest: { sprites: ['janitor_hero'], portraits: ['janitor'] },
  jjajang_statue: { sprites: ['janitor_hero', 'ppaman', 'gyeongsub'], portraits: [...YOUNGCLE_TV_PORTRAITS, 'ppaman', 'gyeongsub', 'janitor'],
