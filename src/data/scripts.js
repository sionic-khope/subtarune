...
import { jjajang_sakura2_bridge } from './cutscenes/jjajang_sakura2.js';   // 벚꽃 숲 2 벚꽃다리(BUILD264)   // 드럼통의 악마 뒤 연출(BUILD254), 동상 뒤 왼쪽 되돌아가기 방지(BUILD260)
...
export const SCRIPTS = {
  ...
  jjajang_think,
  jjajang_stele1, jjajang_stele2, jjajang_stele3, jjajang_stele4, jjajang_stele5, jjajang_nest_drum, jjajang_nest_after, jjajang_statue_return, jjajang_statue_no_return, jjajang_glade_intro, jjajang_sakura_bloom, jjajang_sakura2_bridge,   // 찢칠라 길 2 아래 샛길 마나샘(BUILD244) — 마이야르 샘물과 같은 전체 회복
