...
import { jjajang_nest_after, jjajang_statue_return } from './cutscenes/jjajang_nest_after.js';   // 드럼통의 악마 뒤 연출(BUILD254)
...
export const SCRIPTS = {
  ...
  jjajang_think,
  jjajang_stele1, jjajang_stele2, jjajang_stele3, jjajang_stele4, jjajang_stele5, jjajang_nest_drum, jjajang_nest_after, jjajang_statue_return, jjajang_glade_intro,   // 찢칠라 길 2 아래 샛길 마나샘(BUILD244) — 마이야르 샘물과 같은 전체 회복
