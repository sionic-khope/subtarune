...
export const SCRIPTS = {
  ...
  stage_hall_intro, backstage_ttuulla, rhythm_qa, after_show_qa, stage_right_locked, lava_raft_intro, furnace_arena_intro, furnace_panel, furnace_color_qa, ship_gate,
  storage_viewer,
