...
//  void4_arrive: 도착지 트리거(1회) → 카메라가 억빠맨(물 한가운데 기둥 위)으로 클로즈업 → 대사 → 레버 클로즈업 → 주인공으로 복귀 → "오케이"
...
const PILLAR_TX = 55, LEVER_TX = 109;

export const void4_arrive = Object.assign([
  { wait: 0.5 },
  { parallel: [{ camera: [PILLAR_TX, 5], duration: 1.4 }, { zoom: 2.0, at: 'ppaman', offset: [0, -14], duration: 1.4 }] },
  { wait: 0.3 },
  P('* 어 ㅅㅂ'),
...
export const void4_lever = [
  ...
  { sfx: 'click' },
  { hide: 'lever_off' },
  { spawn: { type: 'prop', id: 'lever_on', image: 'assets/props/lever_on.png', x: 3492, y: 52, w: 24, h: 8, ix: 3492, iy: 28, solid: true, script: 'void4_lever' } },
  { wait: 0.5 },
  { camera: [100, 5], duration: 0.9 },                          // 다리가 떨어질 자리(도착지 쪽 끝)
  { spawn: { type: 'prop', id: 'bridge_fall', image: 'assets/props/bridge_span49.png', x: 1792, y: -40, solid: false, sortY: 0 } },
  { sfx: 'rumble' }, { async: [{ shake: 1.2, amp: 3 }] },
  { move: 'bridge_fall', px: [1792, 179], speed: 95 },          // 드르르르륵 (1초 남짓 내려옴)
