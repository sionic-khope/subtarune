...
export const ARENA_SCENE = Object.freeze({
  ...
  cam: { gajaeman: at(555, 215), party: at(555, 394), wide: at(555, 330), left: at(250, 318), right: at(902, 318),
    leftAlly: at(300, 360), rightAlly: at(852, 360), pit: at(555, 300), orbTop: at(555, -300), above: at(555, 250), giant: at(555, -330),
    rushLeft: at(300, 300) },
...
export const castle_arena_intro = Object.assign([
  ...
  B('허이얍!!!'), close,
  { camera: C.leftAlly, duration: 0.7 },
  ...
  { wait: 0.5 },
  PG('하이얍!!!!!!!!'), close,
  { camera: C.rightAlly, duration: 1.0 },
  ...
  J('저..저게... 저게뭐야!!!!'), close,
  { fade: 'out', duration: 0.5 }, arena(s => { s.showGiant(); s.setFog(0.25, 0.05); s.setFogClear(null); }),
  { camera: C.giant, duration: 0.01 }, { zoom: 0.55, duration: 0.01 }, { fade: 'in', duration: 0.8 }, { shake: 0.6, amp: 3 }, { wait: 0.6 },
  J('괴물이잖아!!!!!!!!!!'), close,
