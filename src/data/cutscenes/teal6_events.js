...
//   1) 와드: 길가에 박힌 토템 와드. "핑크 아니고 토템이네" / "형 정글 아니잖아요" / "박기나 해" → 박으면 "시야가 확보되었다!" → 카메라가 캠프 세 곳을 훑음 → "풀캠이네" / "누구부터?" / "늑대. 골드 효율" / "골드만 보네요" / 경섭 ! "두꺼비가 60원?" / "눈이 왜 그래요".
...
export const teal6_ward = [
  ...
  G('* 새{w=0.2} 늑대{w=0.2} 두꺼비.{w=0.4} 풀캠이네'),
  P('* 누구부터 가요?'),
  G('* 당연히 늑대.{w=0.3} 골드 효율.'),
  P('* 형 진짜 골드만 보네요'),
