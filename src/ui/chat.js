...
const POOL = {
  late: ['왜 이제 옴', '지각 ㅅㅂ', '30분 기다림', 'ㅋㅋㅋㅋ 늦었네', '또 늦음?', '오늘도 지각이냐', '형섭아 시계 없냐', '요플래 ㅈㄴ 늦네', '방송 켜라고', '기다리다 잠듦',
    ...
    '늦은 이유 말해', '8시 35분 어디감', '지각 ㅋㅋㅋㅋ', '뭐 하다 왔냐', '자다 왔지?', '사과부터', '늦었으면 도네 돌려줘', '아 진짜 ㅋㅋ', '지각왕', ...EJS],
  spam: ['극', '락', '극락', '극', '락', '극', '락', 'ㅋㅋㅋㅋ', 'ㅋㅋㅋㅋㅋㅋ', 'ㅋㅋㅋㅋㅋㅋㅋㅋ', '일요일 ㄹㅇ?', '약속 캡처함', '극락 극락', '구라 아니지?', 'ㅋㅋ 일요일 ㄱㄱ', '극', '락', '극락각', '캡처 완료', 'ㅋㅋㅋ 일요일'],
  idle: ['ㅋㅋ', '오늘 떡밥 뭐임', '빨리 시작', 'ㅇㅇ', '?', '보라색 코드 뭐임', '컴퓨터 코드 색 이상함', '떡밥 ㄱㄱ', 'ㅋㅋㅋ', ...EJS],
  question: ['??', '?', '???', '뭐임', '에러?', '뭔 에러', '코드 뭐냐', '보라색 뭐임', '누르지 마', '눌러 ㅋㅋ', '??', '바이러스 아님?', '해결하기 ㅋㅋ', '누르면 어케 됨', '?? 뭐야', '눌러봐', '누르지 마라', ...EJS],
  silence: ['?', '??', '???', '????', '?', '?', '??', '???', '?', '?????', '?', '??', ...EJS, ...EJS],
  panic: ['??', '으아악', '뭐야?', '형섭아', '뭔데 저거', '소용돌이??', 'ㅅㅂ 뭐임', '도망쳐', '화면 뭐냐', '으아악 뭐야?', '?? 뭐야', '뭐야 저거', '컴퓨터 뭐냐', '으아아악', '끄라고', '살려줘', ...EJS],
};
...
export class StreamChat {
  ...
  update(dt) {
    ...
    while (this.timer <= 0 && guard++ < 6) {
      this.post(pick(this.nicks), pick(POOL[this.mode]));
