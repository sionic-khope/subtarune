...
export const RUNNER = Object.freeze({
  ...
  slashTime: 0.42, airSlashTime: 0.46,   // C 베기 / 공중 C 내려치기(사용자 정정: 한 바퀴가 아니라 위에서 아래로 휘두르는 점프 공격). BUILD246: 사용자 “공격 모션 살짝만 0.1초만 더 휘둘럿으면” → 둘 다 +0.1s(판정 창·프레임은 비율이라 같이 늘어난다)
