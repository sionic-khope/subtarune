...
registerTile('d', { name: 'ground_teal_shade', solid: false, draw: flat('#12403c') });   // 그늘 진 땅(걸을 수 있음): 나무 뒤 숨는 공간 (청록숲7, 2026-09-11)   // 숲 바닥(막힘): 길 밖 나무들이 서는 어두운 땅 — 허공에 뜬 나무 방지 (2026-09-11 사용자)
