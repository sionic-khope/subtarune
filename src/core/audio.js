...
export const VOICES = {
  ...
  yongjun:   { freq: 240, wave: 'sawtooth', dur: 0.10, jitter: 60, gain: 0.224, cutoff: 900,  glide: 90, rate: 0.92, level: 0.85, cut: true, minGap: 0.07 },   // 박용준 — 파일 assets/audio/voices/yongjun.mp3(유튜브 쇼츠 LWx1CyyfvvI 9.55s '어?'), 없으면 이 합성
};
