...
export const VOICES = {
  ...
  // 청소부(BUILD226 사용자 3차 “형섭 느낌 빼고 델타룬 거슨에서 살짝 변형”): 거슨(4장) 원음은 아직 미확보(디컴파일 3·4장 브랜치 비어 있음, 사운드 보관 사이트 봇 차단) → **임시** voices/janitor.mp3 = 델타룬 공식 저음 텍스트음 library/sfx/snd_dadtxt 를 -2.6반음(asetrate 0.86)·lowpass 2300·tremolo 26Hz 로 거슨풍으로 변형. 원음(snd_txtgerson 계열)이 오면 같은 변형으로 교체
  janitor: { freq: 300, wave: 'square', dur: 0.16, jitter: 30, gain: 0.22, cutoff: 1800, rate: 0.95, level: 0.8, cut: true, minGap: 0.09 },
