...
export const VOICES = {
  ...
  // 청소부(BUILD226 사용자 “목소리는 형섭 목소리에서 할아버지 느낌으로, 거슨 목소리 델타룬 참고” → “쫌만 더 늙은 느낌으로”): voices/janitor.mp3 = hyungsub.mp3('넌' 0.26s)를 ffmpeg 로 -7반음(asetrate 0.68)·저역(lowpass 1900·bass +5dB)·떨림(tremolo 28Hz d0.55) 처리한 0.38s 변형. 거슨처럼 낮고 갈라진 느낌으로 느리게(rate 0.86), 글자마다 짧게(cut)
  janitor: { freq: 380, wave: 'square', dur: 0.17, jitter: 40, gain: 0.24, cutoff: 2000, rate: 0.86, level: 0.75, cut: true, minGap: 0.1 },
