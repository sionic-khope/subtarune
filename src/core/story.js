...
export const QA_POINTS = [
  ...
  { id: 'teal1',     desc: '청록숲1 오른쪽 길(경섭 합류 후)',               stage: 'void_fallen',    map: 'teal1',  spawn: 'from_left', flags: { void4_arrived: true, bridge_down: true, ppaman_joined: true, lever_taken: true, door_open: true, void8_intro: true, void8_arrived: true, void8_done: true, void10_intro: true, void11_intro: true, void11_done: true }, party: ['ppaman', 'gyeongsub'] },
  { id: 'teal2',     desc: '청록숲2 나무 동상 벽·위로 가는 길',           stage: 'void_fallen',    map: 'teal2',  spawn: 'from_left', flags: { void4_arrived: true, bridge_down: true, ppaman_joined: true, lever_taken: true, door_open: true, void8_intro: true, void8_arrived: true, void8_done: true, void10_intro: true, void11_intro: true, void11_done: true }, party: ['ppaman', 'gyeongsub'] },
  { id: 'teal3',     desc: '청록숲3 숲 공터·공구상자(CS 등장)',            stage: 'void_fallen',    map: 'teal3',  spawn: 'from_bottom', flags: { void4_arrived: true, bridge_down: true, ppaman_joined: true, lever_taken: true, door_open: true, void8_intro: true, void8_arrived: true, void8_done: true, void10_intro: true, void11_intro: true, void11_done: true, statue_hit: true }, party: ['ppaman', 'gyeongsub'] },
  { id: 'teal4',     desc: '청록숲4 긴 길(이벤트 3·걸어다니는 CS)',           stage: 'void_fallen',    map: 'teal_east', spawn: 'from_left', flags: { void4_arrived: true, bridge_down: true, ppaman_joined: true, lever_taken: true, door_open: true, void8_intro: true, void8_arrived: true, void8_done: true, void10_intro: true, void11_intro: true, void11_done: true, statue_hit: true, teal3_battle_pending: true, teal3_cs_won: true, statues_cleared: true }, party: ['ppaman', 'gyeongsub'] },
