...
- `rhythm/tvtime.json`(BUILD218/220 리듬 특별 패턴 차트): `bgm/youngcle_tvform_battle.mp3` 에서 `tools/rhythm/chart.py --player melody --no-video` — 템포 148.000bpm(콤 필터 0.01 해상도, 첫 박 0.176s, 드리프트 3.3ms/171s), 플레이어 노트 = 리드 대역(250~2000Hz 조화곱) 음정이 반음 이상 바뀌어 70ms 유지되는 지점을 1/2박(예외 1/4박 25ms 안)에 양자화한 488개(2.85/s, 홀드 없음, 노트마다 MIDI pitch 62~82) + 사이드 drums 538/vocal 402. 사용자 “노래랑 아예 똑같아야, 음만 다른 거지” — GREAT 마다 그 노트 음의 square 신스(0.15s, gain 0.35). 노트 창은 지금 브금 시각+2초부터 15초. 관객 환호는 무대 씬과 같은 crowd_cheer/roar/applause.
