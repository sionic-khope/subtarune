...
| **청소부** 대사 음색 (BUILD227) | 사용자 “거슨하고 비슷하게” → 델타룬 4장 거슨 웃음 클립 [WiNn1mjmBlw](https://www.youtube.com/watch?v=WiNn1mjmBlw)(Simon Demon, 2025-06-06) | `voices/janitor.mp3` | **적용됨** — 0.462s 부터 ‘하’ 한 음절 0.15s 를 그대로 자름(파일은 피치 변경 없음, 재생 rate 0.9439 = 반키 톤다운). 원본 webm 은 `assets/source/janitor-v1/audio/`. 게임 원본 텍스트음이 들어오면 교체 |
