...
| 얕은 물 발소리(옵젝영역) — 실제 녹음 '찰삭' | `sfx/splash.mp3`(첨벙, 실제 녹음) 의 0.09~0.36s 를 잘라 asetrate 1.3배(작고 가볍게), highpass 350, 0.21s, 피크 -6.4dB. 1차 합성 첨벙("빈도 많고 쫀득")·2차 합성 물방울 울림("물소리 너무 별로 — 진짜 리얼한 찰삭")은 폐기. 언더테일/델타룬 라이브러리엔 물 걸음 소리 없음(`snd_step1/2` 는 마룻바닥) | `sfx/water_step.mp3` | **적용됨** 2026-09-11 (`Player.footstep` 80px 마다, rate 0.9~1.1) |
