...
def main() -> None:
    ...
    data = {
        ...
        'preload': [f'assets/props/summit336_chunk_{i}.png' for i in range(W // 1152)] + [GIANT_IMAGE, 'assets/props/summit342_front.png', 'assets/props/teen342_down.png', 'assets/props/teen342_vacuum.png', 'assets/props/teen342_slam.png'] + [f'assets/props/teen342_rock_{i}.png' for i in range(6)] + [f'assets/props/teenboss339_debris_{i}.png' for i in range(6)] + ['assets/props/teenboss339_knee.png', 'assets/props/cathedral323_sword.png', 'assets/props/arena332_arm.png', 'assets/props/teen347_p2.png', 'assets/battle/cannon-guard/cannon.png', 'assets/battle/cannon-guard/shot.png', 'assets/enemies/baron-roar-idle.png'],
