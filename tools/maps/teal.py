...
me = {'id': 'teal_east', 'name': '청록숲', 'bgm': 'hopes', 'stage': 'void_fallen', 'dim': 0, 'backdrop': 'teal_bush', 'battleBg': 'teal', 'rows': [''.join(r) for r in rows],
      ...
      'entities': ents4}
m7 = placeholder('teal7', {'type': 'door', 'x': 32, 'y': 4 * 32, 'w': 8, 'h': 128, 'to': 'teal6', 'spawn': 'landing', 'sfx': False})   # teal5(물길)=teal5.py, teal6(정글)=teal6.py
maps = {'teal1': m1, 'teal2': m2, 'teal3': m3, 'teal_east': me, 'teal7': m7}
