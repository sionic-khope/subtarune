...
from objlib import JUNHEE_STATUES
...
STATUES = cycle(JUNHEE_STATUES)   # 포즈 6종 (목록은 tools/maps/objlib.py — 옵젝영역2 도 같은 것을 쓴다)
...
me = {'id': 'teal_east', 'name': '청록숲', 'bgm': 'hopes', 'stage': 'void_fallen', 'dim': 0, 'backdrop': 'teal_bush', 'battleBg': 'teal', 'rows': [''.join(r) for r in rows],
      ...
      'entities': ents4}
maps = {'teal1': m1, 'teal2': m2, 'teal3': m3, 'teal_east': me}   # teal5~9 는 각자 생성기(teal5.py … teal9.py), teal9 다음은 옵젝영역(obj0.py)
