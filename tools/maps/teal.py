...
me = {'id': 'teal_east', 'name': '청록숲', 'bgm': 'hopes', 'stage': 'void_fallen', 'dim': 0, 'backdrop': 'teal_bush', 'battleBg': 'teal', 'rows': [''.join(r) for r in rows],
      ...
      'entities': ents4}
m6 = placeholder('teal6', {'type': 'door', 'x': 32, 'y': 4 * 32, 'w': 8, 'h': 128, 'to': 'teal5', 'spawn': 'landing', 'sfx': False})   # teal5(물길) 는 tools/maps/teal5.py
maps = {'teal1': m1, 'teal2': m2, 'teal3': m3, 'teal_east': me, 'teal6': m6}
