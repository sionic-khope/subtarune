...
set -e
/usr/bin/python3 tools/maps/rockfall_map.py void5 --rocks 3 --entry left --exit down --prev void4 --next void6 --tail 14 --props '[{"type": "prop", "id": "flowers", "image": "assets/props/flowers_purple.png", "x": 960, "y": 150, "solid": true, "script": "rock_flowers"}]' "$@"
