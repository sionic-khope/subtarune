...
- 달리기 구간 33~199열 ≈ 5250px / 520px/s ≈ 10초 → 맵 오른쪽 안쪽(끝 96px 앞)에서 제동. 소나무·검은 숲은 소나무 숲과 같은 지역 자산, 브금 my_castle_town 이어짐."""
...
RUN_END_MARGIN: Final = 96            # 제동 목표 = 맵 오른쪽 끝 - 96px
RUN_SPEED: Final = 520
...
def build_map() -> dict[str, object]:
    ...
    return {
        ...
        'bgm': 'my_castle_town',
        'dim': 0.08,
        'preload': ['assets/sprites/hyungsub-runner-prep.png', 'assets/sprites/hyungsub-runner-run.png', 'assets/sprites/hyungsub-runner-jump.png', 'assets/sprites/hyungsub-runner-slash.png'],
