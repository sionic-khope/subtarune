...
def build_map() -> dict[str, JsonValue]:
    ...
    return {
        ...
        "meta": {
            "connected": True, "puzzle": "crate", "difficulty": "medium", "pushes": 8,
            "solution": ["R", "R", "U", "R", "R", "R", "U", "U"], "crateStart": [194, 290],
            "plates": [[352, 192]], "gate": [448, 160, 24, 224], "moveArea": [4, 5, 9, 7],
        },
        "entities": [
            ...
            # 2026-09-15 난이도 소폭 상향: 격벽을 위(row1~2)·아래(row4~5) 둘로 나눠 row3 한 칸 틈만 남기고,
            # 발판을 틈 너머 오른쪽 위(col7,row1)로 옮겨 R R U R R R U U — 방향 전환 3회. 틈을 안 읽고 col4에서 위로 계속 밀면 맨 윗줄에 갇힌다(초기화 콘솔로 복구)
            {"type": "factory_bulkhead", "id": "youngcle4_bulkhead_top", "x": 288, "y": 192,
             "w": 32, "h": 64},
            {"type": "factory_bulkhead", "id": "youngcle4_bulkhead_bottom", "x": 288, "y": 288,
             "w": 32, "h": 64},
            {"type": "factory_wire", "id": "youngcle4_wire", "puzzle": PUZZLE, "flag": FLAG,
             "points": [[368, 208], [400, 208], [400, 176], [448, 176]]},
            ...
            {"type": "factory_crate", "id": "youngcle4_crate", "puzzle": PUZZLE, "flag": FLAG,
             "x": 194, "y": 290, "solvedX": 354, "solvedY": 194},
