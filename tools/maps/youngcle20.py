...
왼쪽 위 홀로그램 탁자, 왼쪽 콘솔 2×2 + 오른쪽 아래 콘솔 둘, 왼쪽 아래 반응로(바닥 연두 유도등은 사용자 요청으로 뺌). 가운데·오른쪽은 입장 연출(BUILD202 ship_control_intro: 대포 → 쥰희·용준 날아감 → 영클 등장 → 철창·오방순·나람 → 전투 시작)을 위해 비운다.
...
TV_STAND = (556, 324)                                # 변신 영클(TV 머리, 0.85배)이 서는 자리 — 24px 아래라 카메라 위쪽에 머리가 안 잘린다(2026-09-17 사용자)
