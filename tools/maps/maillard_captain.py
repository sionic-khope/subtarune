    ...
    map_data = {
        ...
        'entities': [
            ...
            {'type': 'npc', 'id': 'captain_mankatsuki', 'sprite': 'junhee_mankatsuki',
             ...
             'requires': 'captain_reveal_done', 'unless': 'captain_aftermath_done',
             'script': 'captain_mankatsuki'},
            {'type': 'npc', 'id': 'captain_junhee_restored', 'sprite': 'junhee',
             'x': 420, 'y': 270, 'facing': 'down', 'wander': 0,
             'requires': 'captain_aftermath_done', 'unless': 'captain_attack_done',
             'script': 'captain_aftermath'},
