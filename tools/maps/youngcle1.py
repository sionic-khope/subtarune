...
def main() -> None:
    ...
    map_data = {
        ...
        'entities': [
            ...
            {'type': 'sign', 'id': 'youngcle_tv_screen', 'x': 624, 'y': 196,
             'w': 96, 'h': 12, 'solid': False, 'script': 'youngcle_tv_off'},
            ...
            {'type': 'sign', 'id': 'youngcle_right_door', 'x': 1184, 'y': 180,
             'w': 80, 'h': 32, 'solid': False, 'script': 'youngcle_right_door_pending'},
