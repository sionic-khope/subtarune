...
3. JSON 작성:
   ...
   - **낙석 레인**: `{ "type":"rockfall","image":"assets/props/rock.png","x":레인중심,"ground":착지y,"period":2.0,"offset":…,"warn":0.7,"fall":0.2,"rest":0.4 }` — 3타일 간격, 리듬은 offset. 맵엔 `dim:0.3` 을 줘서 빛기둥이 보이게. 예 `void5/6/7`.
