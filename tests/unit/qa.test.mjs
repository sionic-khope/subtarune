...
test('test_party_from_flags_walk_order_gyeongsub_then_ppaman', () => {
  ...
  assert.deepEqual(partyFromFlags({ castle_malzahar_split: true, castle_pipe_ready: true }), []);
  assert.deepEqual(partyFromFlags({ castle_malzahar_split: true, castle_pipe_ready: true, castle_pipe_returned: true }), ['gyeongsub', 'ppaman']);
});
