...
const ROAD = new Set(['t', 'u', 'w', 'n', 'r', 'R', 'a', 'A', 'j', 'E', 'x', 'X', 'z', 'b', 's', '.', ',', 'f', 'g', 'h', 'i', 'k', 'l', 'D', 'B', 'M', 'I', ':', ';', '/', '%', '?', '$', '"', '*', 'U', '(', ')']);   // $ " = 짜장숲부터의 에코 길·공터 풀숲(BUILD226~227), U = 깊은숲 입구 어두운 길(BUILD254)
const WALK = new Set([...ROAD, 'd', 'F', 'H', 'N', '&', '+', '^']);   // ^: 깊은숲 입구 길 가장자리 출입구(BUILD254)   // F: 용광로 구역 바닥(BUILD189), H: 가장자리 출입구 칸(BUILD194, 걷는다), N: 용암 위 다리 바닥(BUILD201)
