...
export const BASE_URL_SCENARIOS = new Set(['drum-devil-battle', 'drum-devil-intro', 'battle_lose', 'battle_bgm', 'tvform-rhythm', 'tvform-subrio-b', 'tvform-subrio', 'tvform-subrio-guard', 'ship-lounge', 'ship-ending', 'ship-castle', 'jjajang-shore', 'sinking-shore', 'choimis']);
