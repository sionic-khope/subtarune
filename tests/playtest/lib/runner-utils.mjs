...
export const BASE_URL_SCENARIOS = new Set(['battle_lose', 'battle_bgm', 'tvform-rhythm', 'tvform-subrio-b', 'tvform-subrio', 'tvform-subrio-guard', 'ship-lounge', 'ship-ending']);
