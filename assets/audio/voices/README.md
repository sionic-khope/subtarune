...
- janitor.mp3(청소부, 2026-09-18): hyungsub.mp3 를 ffmpeg 로 -7반음(asetrate 48000*0.68)·highpass 100·lowpass 1900·tremolo 28Hz d0.55·bass +5dB@170 처리한 0.38s 변형(2차: “쫌만 더 늙은 느낌”)(사용자 “형섭 목소리에서 할아버지 느낌으로, 거슨 목소리 델타룬 참고”). 재현 명령은 assets/source/janitor-v1/README.md. VOICES.janitor rate 0.86
