...
# Run from any directory: uv run assets/source/park155/process.py
# Optional first argument: directory containing the seven original exec-*.png files.
# ──────────────────
"""Deterministically export the seven generated Park Guardian action sheets."""
...
ACTIONS: Final = (
    Action("attack", "1c6d2cf1-a4ec-42bb-bf70-05f3513d95e4", 3, 2, 80 / 476),
    Action("scratch", "6b2f6d71-329e-4867-b67b-94141bd1ae42", 2, 2, 80 / 474, 128),
    Action("adjust", "16f49216-2fb7-4301-bfa7-cc51d63bb575", 2, 2, 80 / 536),
    Action("dance", "f8c239d9-7d2b-40a9-99b5-7deaed0ec74c", 2, 2, 80 / 515),
    Action("loose", "83085863-f474-465a-8b5a-c2d5a3c827af", 2, 2, 80 / 515),
    Action("slipping", "6985051c-5ae1-4741-b2d6-aef20236d910", 2, 2, 80 / 515),
    Action("empty-costume", "cf83653e-869d-42fe-b0a4-952a9a994452", 1, 1, 80 / 1098),
)
...
def standard_pass(action: Action) -> None:
    ...
    command = [
        ...
        "--cell-size", "96", "--fit-scale", "0.84", "--align", "feet",
        ...
        "--prompt-file", str(ROOT / "prompts.md"), "--strict-qc",
    ]
...
def export(action: Action) -> Image.Image:
    ...
    runtime = GAME / "assets/enemies" / f"park-guardian-{action.name}.png"
    sheet.save(runtime)
...
def main() -> None:
    ...
    preview = Image.new("RGBA", (2048, 1280), (30, 33, 43, 255))
