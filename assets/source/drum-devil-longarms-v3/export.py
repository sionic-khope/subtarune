...
# Run: uv run assets/source/drum-devil-longarms-v3/export.py
# ──────────────────
...
def main() -> None:
    ...
    for action, roots in ROOTS.items():
        raw_name = "attack-compact-raw.png" if action == "attack" else "idle-raw.png"
    ...
    with Image.open(HERE.parent / "drum-devil-wings-v2" / "idle-0.png") as old:
        before_after.alpha_composite(old, (0, -30))
