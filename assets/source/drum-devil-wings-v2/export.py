...
# Run: uv run assets/source/drum-devil-wings-v2/export.py
# ──────────────────
...
PIVOT: Final = (216, 350)
ROOTS: Final = {
    "idle": ((336, 584), (963, 584), (337, 1184), (963, 1185)),
    "attack": ((351, 602), (953, 603), (440, 1180), (956, 1187)),
}
...
def main() -> None:
    ...
    with Image.open(HERE / "idle-0.png") as idle:
        field = idle.crop((72, 116, 344, 356))
        field.save(ROOT / "assets" / "enemies" / "drum-devil-field.png")
        field.save(HERE / "field-transparent.png")
        metadata["field"] = {"source": "idle-0.png", "cropXYWH": [72, 116, 272, 240],
                             "size": [272, 240], "pivot": [144, 234], "scale": 1}
