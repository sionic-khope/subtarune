...
REF 05 "$J0" "$S/junhee_point.png=Junhee pointing" -- "$P/maillard-ship.png=Maillard pig ship"
...
REF 09 "$S/choimis-masked-walk.png@4,4,0,0=Choimis in Discord mask" "$H0" "$G0" "$PP0" -- "$PL/sakura6.png=place: cherry plaza"
REF 10 "$S/gajaeman_shadow.png@4,4,0,0=Gajaeman" "$H0" "$G0" "$PP0" "$S/youngcle_hover.png@4,4,0,0=Youngcle on hover" -- "$PL/arena.png=place: castle arena"
REF 11 "$S/gyeongsub.png@4,4,0,1=Gyeongsub back" "$S/hyungsub.png@4,4,0,1=Kim Hyungsub back" "$S/ppaman.png@4,4,0,1=Eokppaman back" -- "$PL/sunset.png=place: sunset land"
rm -rf $TMP
