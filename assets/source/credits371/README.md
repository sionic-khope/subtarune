...
- 최미스 참조는 `refs/choimis-masked-noletters.png`(가면 걷기 시트 정면 셀, 가슴 GAP 글자를 셔츠 분홍으로 칠함). 꽃 형태 참조는 쓰지 않음.
...
| 03 | 쥰희·용준이 돼지코 나무 대포 만들며 낄낄 | obj1 (옵젝영역1, obj1_cannon) | ref03 | photo03-rawv2b.png |
| 04 | 바론이 용준을 움켜쥐고 도망, 일행 놀라 물길 추격 | obj4 (옵젝영역4, obj4_baron) | ref04 | photo04-rawv2b.png |
| 05 | 물길에 내려앉은 돼지 모양 마이야르호 뱃머리의 쥰희 | obj5 (obj5_maillard) | ref05 | photo05-rawv2.png |
| 06 | 엄청대박인배 라운지의 편집노조(비데·파크가디언·뚜울라·도트마리오) | ship_lounge | ref06 | photo06-rawv2b.png |
| 07 | 벗겨진 인형탈, 인면견 파크가디언을 놀리는 쥰희·영클, 비데·마리오 | 편집노조 스테이지(youngcle7) | ref07 | photo07-rawv2.png |
| 08 | 드럼통 둥지: 드럼통의 악마 — 웃는 청소부 — 요플래 | jjajang_nest | ref08 | photo08-rawv2.png |
| 09 | 벚꽃 광장에서 디스코드 가면 최미스(글자 없는 분홍 옷)의 이상한 춤을 숨어 구경 | jjajang_sakura6 | ref09 | photo09-rawv2b.png |
| 10 | 결전지 원형 난간 위 가재맨 vs 일행(영클은 호버) | castle_arena | ref10 | photo10-rawv2.png |
| 11 | 노을 땅, 경섭이 김형섭을 업고 억빠맨·영클과 해 쪽으로 걸어감 | gajaeman_castle_sunset | ref11 | photo11-rawv2.png |
