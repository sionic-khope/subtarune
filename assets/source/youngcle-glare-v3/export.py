...
"""영클 TV 표정 ‘glare’(째려봄) — gpt-image-2 raw(마젠타 배경) → youngcle151 과 같은 규격으로 TV 삽화 + 대화 초상.
   ...
   사용: uv run --with pillow --with numpy python assets/source/youngcle-glare-v3/export.py (2.5-sunburst raw) (151 스크립트가 dataclass slots 를 써서 3.10+)"""
...
HERE = ROOT / 'assets/source/youngcle-glare-v3'
